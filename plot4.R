...
# Set a 2 by 2 plot window
par(mfrow = c(2, 2))

# First plot
plot(data_relevant$DateTime, data_relevant$Global_active_power, type = "l",xlab = "", ylab = "Global Active Power")

# Second plot
plot(data_relevant$DateTime, data_relevant$Voltage,type = "l", xlab = "datetime", ylab = "Voltage")

# Third plott
plot(data_relevant$DateTime, data_relevant$Sub_metering_1, col = "black",
     type = "l",
...
# Fourth plot
plot(data_relevant$DateTime, data_relevant$Global_reactive_power, 
     type = "l",
     col = "black",
